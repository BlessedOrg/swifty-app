...
export const EventLottery = ({
    ...
    const getLotteryAddresPerActivePhase = {
    ...
    const activeLotteryAddress = useMemo(()=> getLotteryAddresPerActivePhase?.[activePhase?.idx] || "", [activePhase?.idx]);
    const lotteryAddresses =  [{address: eventData.lotteryV1contractAddr, id: "lotteryV1"}, {address: eventData.lotteryV2contractAddr, id: "lotteryV2"}, {address: eventData.auctionV1contractAddr, id: "auctionV1"}, {address: eventData.auctionV2contractAddr, id: "auctionV2"}]
