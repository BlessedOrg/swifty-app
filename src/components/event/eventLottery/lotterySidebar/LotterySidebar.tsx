    ...
    >
      <Flex flexDirection={"column"} gap={{base: 1, iwMid: 4}}>
        <Flex gap={4} alignItems={"center"} px={4}>
          <Flex rounded={"100%"} overflow={"hidden"} w={{base: "40px", iwMid:"52px"}} h={{base: "40px", iwMid:"52px"}}>
            <Image
              src={userData.avatar}
              alt={"user avatar"}
              width={100}
          ...
          <Flex flexDirection={"column"} gap={1}>
            <Text fontSize={{base: "14px", iwMid: "17px"}} fontWeight={"bold"}>
              {userData.username}
            </Text>
        ...
        >
          <Text fontWeight={"bold"} fontSize={{base: "1.5rem", iwMid: "3rem"}}>
      ...
      <Flex
        ...
        h={"100%"}
      >
        <Flex flexDirection={"column"} gap={{base: 2, iwMid: 4}} alignItems={'center'} overflow={'hidden'} py={2}>
          {mintEnabled ? (
            <Button
