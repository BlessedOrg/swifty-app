...
import { RendererCard } from "@/components/event/interactiveWindow/RendererCard";
import Link from "next/link";
import Image from "next/image";
import EventNotConfigured from "@/components/event/interactiveWindow/EventNotConfigured";
