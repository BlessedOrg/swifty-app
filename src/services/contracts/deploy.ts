  ...
  try {
    const setBaseContractsTx = await client.writeContract({
      ...
      args: [
        ...
        "0xE9EE24F2097eb3B06448C032d1Aef19cb23cDd9c", // LotteryV1 with VRF mock due to Gelato malfunction
        "0x4D39c94A23E5af44673314309c21Fc6548C1E2f6", // LotteryV2 with VRF mock due to Gelato malfunction
        "0xC430CF9193b0197d6eB71137990e8b47A8824Dfc", // AuctionV1 with VRF mock due to Gelato malfunction
